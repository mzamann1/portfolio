 ...
 * 
 * A custom cursor component that replaces the default browser cursor.
 * Features a dot and ring that follow the mouse with spring physics,
 * and responds to hover and click interactions.
 */
...
/**
 * CustomCursor component that follows mouse movement with spring physics
 */
