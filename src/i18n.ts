...
const resources = {
  en: {
    translation: {
      ...
      clear_all: "Clear All",
      showing_experiences_with: "Showing experiences with",
  ...
  ar: {
    translation: {
      ...
      search_experience: "البحث في الخبرات...",
      filter: "تصفية",
      compact_view: "مدمج",
      timeline_view: "الجدول الزمني",
      filter_by_skills: "تصفية حسب المهارات",
      clear_all: "مسح الكل",
      showing_experiences_with: "عرض الخبرات مع",
      showing_results: "عرض",
      of: "من",
      experiences: "الخبرات",
